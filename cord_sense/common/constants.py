...
MODEL_TYPES = ['cnn', 'lstm', 'cnn_lstm', 'random_forest', 'gradient_boosting', 'xgb_regressor', 'stacked_rf_gb']
FEATURE_NAMES = ['area', 'angle_AP', 'angle_RL', 'diameter_AP', 'diameter_RL', 'eccentricity', 'orientation', 'solidity', 'torsion']